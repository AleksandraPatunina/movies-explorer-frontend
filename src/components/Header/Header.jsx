...
// закрытие бургер-меню при изменении размера окна браузера
  useEffect(() => {
  ...
  return (
    <header className={`header page__header ${name !== 'home-page' ? 'page__header_type_page' : ''}`}>
      <div>
        <Link to={'/'} className="header__link-home"></Link>
      </div>
      {name === 'home-page' && !loggedIn ?
        <nav>
